...
STATIC_REFERENCE_BASELINE_JSON = CONFIG_DIR / "static_reference_baseline.json"
ADAPTIVE_TUNING_JSON = CONFIG_DIR / "adaptive_tuning.json"
NORMALIZATION_SEED_RULES_JSON = CONFIG_DIR / "normalization_seed_rules.json"
